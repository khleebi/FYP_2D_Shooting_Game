...
public static class Settings
{
    ...
    public const int maxDungeonRebuildAttemptsForMapStructureGraph = 1000;
    ...
    public const float musicFadeOutTime = 2f;  // Defualt Music Fade Out Transition
    public const float musicFadeInTime = 2f;  // Default Music Fade In Transition
